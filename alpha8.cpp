...
//	Al leer y escribir float en los archivos genera errrores
//	las funciones eliminar no funciona bien, dañan el archivo notas.txt
//la funcion editar notas no fue dearrollada ya que se necesita de la funcion eliminar notas y igualmente dañaria el archivo notas.txt
//la funcion listar notas solo muestra un registro de notas
//estudiante solo muestra un registro de notas
//profesor solo muestra un registro de notas y la funciones agregar y eliminar notas no esatn personalizadas para cada caso
...
void mostrarRegistroNota(string codigo);//f
void listarEst();//ya
...
void editarNota()
{
	//cuando funcione eliminar notas
}
