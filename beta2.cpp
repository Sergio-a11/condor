//Sergio Andrés Cruz Guerrero
//20192578014
//nombre para el archivo de admins = usuarioAdmin.txt "\n" codigo "\n" clave
//	las notas estan manejadas con strings, solo no da el promedio
...
//las mas de 30 funciones restantes funcionan bien
#include<iostream>
#include<stdlib.h>
#include<string.h>
#include<conio.h>
...
void listarNotas();//ya
void fail();//ya
void datosEst(string codigo, string nombre);//ya
void datosProf(string codigo, string nombre, string materia1, string materia2);//ya
void agregarNotaProf(string codigo, string materia);//ya
void eliminarNotaProf(string codigo, string materia1);//ya
void editarNotaProf(string codigo, string materia1);//ya
//20192578014
...
//							cout<<"                         Nota Final: "<<nota.notaFinal<<endl;
				...
				{
					case 1:
						agregarNotaProf(codigo, auxmat1);
					break;
					case 2:
						eliminarNotaProf(codigo, auxmat1);
					break;
					case 3:
						editarNotaProf(codigo, auxmat1);
					break;
					case 4:
						exit(1);
					break;
...
//							cout<<"                         Nota Final: "<<nota.notaFinal<<endl;
				...
				{
					case 1:
						agregarNotaProf(codigo, auxmat2);
					break;
					case 2:
						eliminarNotaProf(codigo, auxmat2);
					break;
					case 3:
						editarNotaProf(codigo, auxmat2);
					break;
					case 4:
						exit(1);
					break;
...
void agregarNotaProf(string codigo, string materia)
{
	ifstream leer;
	ofstream escribir;
	bool existe=false;
...
void eliminarNotaProf(string codigo, string materia1)
{
	ifstream leer;
	ofstream auxiliar;
	bool existe=false;
...
//			leer>>nota.nota3;
			fflush(stdin);
//			leer>>nota.notaFinal;
			if(estudiante==nota.auxCodigoEst and profesor==codigo and materia==materia1)
			{
				existe=true;
				system("cls");
							cout<<"\n--------------------------------------------------------------------------------";
...
void editarNotaProf(string codigo, string materia1)
{
	ifstream leer;
	ifstream verificador;
	ofstream auxiliar;
	...
	if(leer.is_open() and verificador.is_open() and auxiliar.is_open())
	{
		...
		while(!leer.eof())
		{
			...
			getline(leer,nota.nota2);
			getline(leer,nota.nota3);
			if(nota.auxCodigoEst==nota.codigoEst and codigo==nota.codigoProf and materia1==nota.codigoMat)
			{
				existe=true;
				mostrarRegistroNota(codEst,codProf,codMat);
				cout<<"\n--------------------------------------------------------------------------------"<<endl;
...
//					}while(nota.auxCodigoMat=="");
//				}
				if(nota.auxCodigoEst==codEst and codigo==codProf and materia1==codMat)
				{
					repetido=true;
				}
				if(repetido==false)
...
//								}
						...
						if(verificador.eof() and (nota.auxCodigoEst!=nota.codigoEst or codigo!=nota.codigoProf or materia1!=nota.codigoMat))
						{
							coincidencia=false;
						}
					}while(coincidencia==true);
			...
			cout<<"\n--------------------------------------------------------------------------------"<<endl;	
			cout<<"                Digite el código del estudiante: "<<nota.auxCodigoEst<<endl;
			cout<<"\n                Digite el código del profesor: "<<codigo<<endl;
			cout<<"\n                Digite el código de la materia: "<<materia1<<endl;
			cout<<"\n                Digite la nota 1 [35%]: ";
			fflush(stdin);
			getline(cin,nota.auxnota1);
			if(nota.auxnota1<"0" or nota.auxnota1>"5")//seguridad 2
